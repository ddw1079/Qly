			...
			<div class="row">
				...
				<div class="col-md-8 mb-4">
					<div class="card shadow">
						...
						<div class="card-body">
							<p class="card-text fs-5">고양이 번지점프시키기!!! 고양이 번지점프시키기!!! 고양이
								번지점프시키기!!! 고양이 번지점프시키기!!! 고양이 번지점프시키기!!! 고양이 번지점프시키기!!! 고양이
								번지점프시키기!!! 고양이 번지점프시키기!!! 고양이 번지점프시키기!!! 고양이 번지점프시키기!!!</p>
							<hr>
				...
				<div class="col-md-4">
					<div class="card shadow h-100">
						<div class="card-body d-flex flex-column justify-content-between">
							<div class="mb-4">
								<label class="form-label bg-warning p-2 d-inline-block rounded">날짜
									선택</label>
								<!-- 인라인 달력 표시용 -->
							...
							<div class="text-end mt-auto">
								<button type="submit" class="btn btn-warning submit-btn">퀘스트
									신청</button>
							</div>
						</div>
					</div>
