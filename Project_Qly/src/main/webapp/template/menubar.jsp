...
.nav-buttons a, .nav-buttons .dropdown-toggle, .nav-buttons button {
	padding: 6px 16px;
...
.nav-buttons a:hover, .nav-buttons .dropdown-toggle:hover, .nav-buttons button:hover
	{
		...
		<div class="nav-buttons">
			...
			<div class="dropdown">
				...
				<ul class="dropdown-menu" aria-labelledby="introDropdown">
					<li><a class="dropdown-item"
						href="<c:url value='/template/qly_Introduction.jsp' />">플랫폼 소개</a></li>
					<li><a class="dropdown-item"
						href="<c:url value='/template/qly_Introduction2.jsp' />">팀 소개</a></li>
				</ul>
			</div>
			...
			<div class="dropdown">
				<a class="btn dropdown-toggle" href="javascript:void(0);"
					id="questDropdown" role="button" data-bs-toggle="dropdown"
					aria-expanded="false"> 퀘스트 </a>
				<ul class="dropdown-menu" aria-labelledby="questDropdown">
					<li><a class="dropdown-item"
						href="<c:url value='/quest/list.do' />">퀘스트 목록</a></li>
					<li><a class="dropdown-item"
						href="<c:url value='/quest/registerForm.do' />">퀘스트 등록</a></li>
				</ul>
			</div>

			<a href="<c:url value='/payments/history.do' />">코인</a> <a
				href="<c:url value='/inquiry/list.do' />">고객센터</a>
		</div>
