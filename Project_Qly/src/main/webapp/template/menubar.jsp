			...
			<div
				...
				<c:choose>
					<c:when test="${not empty loginUser}">
						<a
							href="<c:url value='${loginUser.userType eq "관리자" ? "/admin/memberList.do" : "/mypage/user_layout.do?page=personal_info.jsp"}' />">
						...
						<c:otherwise>
							<c:choose>
								...
								<c:otherwise>
									<button class="btn w-100 mt-1"
										style="background-color: #2c3e50; color: white; font-weight: bold; font-size: 14px; border-radius: 8px;"
										onclick="location.href='${pageContext.request.contextPath}/mypage/user_layout.do?page=personal_info.jsp'">마이페이지</button>
								</c:otherwise>
							</c:choose>
							<button class="btn w-100 mt-1"
								style="background-color: #2c3e50; color: white; font-weight: bold; font-size: 14px; border-radius: 8px;"
			...
			<div class="submenu-container">
				<div class="submenu-row">
					<div class="submenu-cell">
						<a href="/mypage/qlyIntro.do">QLY란?</a> <a
							href="/mypage/companyIntro.do">회사 소개</a>
					</div>
					<div class="submenu-cell">
