    ...
    <ul class="sidebar-menu">
        <li onclick="toggleSubmenu('profileMenu')">
            ...
            <ul id="profileMenu" class="submenu">
                <li onclick="location.href='user_layout.jsp?page=../info/personal_info.jsp'">정보 조회</li>
                <li onclick="location.href='user_layout.jsp?page=../info/edit_personal_info.jsp'">정보 수정</li>
            </ul>
        </li>
        ...
        <li onclick="toggleSubmenu('questMenu')">
            ...
            <% if ("Qlee".equals(userType)) { %>
                <li id="subQuest1" onclick="location.href='user_layout.jsp?page=../quest/questCard.jsp'">퀘스트 목록</li>
                <li id="subQuest2" onclick="location.href='user_layout.jsp?page=../quest/questHistory.jsp'">퀘스트 진행 상황</li>
            <% } else { %>
                <li id="subQuest1" onclick="location.href='user_layout.jsp?page=../quest/heagual_questCard.jsp'">해결 내역</li>
                <li id="subQuest2" onclick="location.href='user_layout.jsp?page=../quest/heagual_questHistory.jsp'">퀘스트 신청 목록</li>
            <% } %>
            </ul>
        </li>
        ...
        <li onclick="toggleSubmenu('coinMenu')">
            ...
            <ul id="coinMenu" class="submenu">
                <li onclick="location.href='user_layout.jsp?'">코인 충전</li>
                <li onclick="location.href='user_layout.jsp?'">코인 환불</li>
            </ul>
        </li>
    </ul>
