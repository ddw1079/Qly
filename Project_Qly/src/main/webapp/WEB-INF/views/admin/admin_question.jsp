...
<body>
	...
	<div class="d-flex gap-4 flex-wrap mb-5">
		...
		<div class="step-guide-card" style="min-width: 400px;">
			<div class="step-box">
				1. 미답변 처리 <br> <small style="opacity: 0.8;">답변 안 된 문의
					확인</small>
			</div>
			<div class="step-box"
				style="background: linear-gradient(to right, #a18cd1, #fbc2eb);">
				2. FAQ 등록 <br> <small style="opacity: 0.8;">반복 문의 정리</small>
			</div>
			<div class="step-box"
				style="background: linear-gradient(to right, #ff758c, #ff7eb3);">
				3. 메모 작성 <br> <small style="opacity: 0.8;">운영 정책 기록</small>
			</div>
		</div>
	</div>
			...
			<tbody>
				<tr>
					...
					<td><button class="btn btn-sm btn-outline-primary"
							data-bs-toggle="modal" data-bs-target="#answerModal">답변</button></td>
				</tr>
				<tr>
					<td>Q2025002</td>
					<td>충전 내역이 사라졌어요</td>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">문의 답변 작성</h5>
					<button type="button" class="btn-close" data-bs-dismiss="modal"></button>
				</div>
				<div class="modal-body">
					<textarea class="form-control" rows="6" placeholder="답변 내용을 입력하세요"></textarea>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary"
						data-bs-dismiss="modal">닫기</button>
					<button type="button" class="btn btn-primary">답변 저장</button>
				</div>
			</div>
		</div>
	</div>
