...
<div
	...
	<ul class="sidebar-menu"
		...
		<li
			...
			onclick="location.href='admin_layout.jsp?page=admin_memberList.jsp'">회원
			관리</li>

		<li
			class="<%=currentPage.equals("admin_questList.jsp") ? "active" : ""%>"
			onclick="location.href='admin_layout.jsp?page=admin_questList.jsp'">퀘스트
			관리</li>

		<li
			class="<%=currentPage.equals("admin_coinList.jsp") ? "active" : ""%>"
			onclick="location.href='admin_layout.jsp?page=admin_coinList.jsp'">코인
			관리</li>

		<li
			class="<%=currentPage.equals("admin_qusetion.jsp") ? "active" : ""%>"
			onclick="location.href='admin_layout.jsp?page=admin_qusetion.jsp'">사용자
			문의</li>



		<li class="<%=currentPage.equals("admin_sales.jsp") ? "active" : ""%>"
			onclick="location.href='admin_layout.jsp?page=admin_sales.jsp'">매출
			통계</li>

		<li
			class="<%=currentPage.equals("admin_policy.jsp") ? "active" : ""%>"
			onclick="location.href='admin_layout.jsp?page=admin_policy.jsp'">사내
			게시판</li>

		<li
			class="<%=currentPage.equals("admin_security.jsp") ? "active" : ""%>"
			onclick="location.href='admin_layout.jsp?page=admin_security.jsp'">보안
			정책</li>

		<li
			class="<%=currentPage.equals("admin_setting.jsp") ? "active" : ""%>"
			onclick="location.href='admin_layout.jsp?page=admin_setting.jsp'">환경
			설정</li>
	</ul>
</div>
