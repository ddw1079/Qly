...
<div style="display: flex; gap: 20px; margin: 30px 0;">
  <!-- 총 회원 수 -->
  <div style="flex: 1; padding: 20px; background: white; border-radius: 10px; box-shadow: 0 0 5px rgba(0, 0, 0, 0.1); position: relative;">
    <h5>총 회원 수</h5>
    <p>112명</p>
    <img src="https://i.postimg.cc/T3vKs6wX/user.png" alt="회원 아이콘" style="position: absolute; bottom: 10px; right: 10px; width: 48px;">
  </div>
  ...
  <div style="flex: 1; padding: 20px; background: white; border-radius: 10px; box-shadow: 0 0 5px rgba(0, 0, 0, 0.1); position: relative;">
    <h5>총 퀘스트 수</h5>
    <p>48건</p>
    <img src="https://i.postimg.cc/VkZ36Ybx/quest.png" alt="퀘스트 아이콘" style="position: absolute; bottom: 10px; right: 10px; width: 48px;">
  </div>
  ...
  <div style="flex: 1; padding: 20px; background: white; border-radius: 10px; box-shadow: 0 0 5px rgba(0, 0, 0, 0.1); position: relative;">
    <h5>보유 코인 합계</h5>
    <p>74,000 Qubit</p>
    <img src="https://i.postimg.cc/1zxrM2xg/dollar.png" alt="코인 아이콘" style="position: absolute; bottom: 10px; right: 10px; width: 48px;">
  </div>

  <!-- 최근 가입 회원 -->
  <div style="flex: 1; padding: 20px; background: #6aaea7; border-radius: 10px; color: white; box-shadow: 0 0 8px rgba(0, 0, 0, 0.15);">
    <h5>최근 7일 신규 가입</h5>
...
<div style="display: flex; gap: 20px; margin-bottom: 30px;">
  <!-- 캘린더 및 오늘 일정 -->
  <div style="flex: 2; background: white; border-radius: 10px; padding: 20px; box-shadow: 0 0 6px rgba(0, 0, 0, 0.1);">
    ...
    <div style="display: flex; gap: 5px;">
      ...
      <div style="flex: 1;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
          ...
          <button id="openScheduleModal" class="btn btn-outline-primary btn-sm">+ 새 일정</button>
        </div>
  ...
  <!-- 최근 7일 활동 차트 -->
  <div style="flex: 1; padding: 20px; background: white; border-radius: 10px; box-shadow: 0 0 6px rgba(0, 0, 0, 0.1); text-align: center;">
...
<!--  일정 추가 모달 -->
<div id="modalBackdrop" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.4); z-index: 9998;"></div>

<div id="scheduleModal" style="display: none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); background: white; padding: 24px; border-radius: 10px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.2); z-index: 9999; width: 350px;">
  <h5>새 일정 추가</h5>
  <label>날짜:</label>
  <input type="text" id="scheduleDate" class="form-control" style="margin-bottom: 10px;" readonly>
  <label>시간:</label>
  <input type="time" id="scheduleTime" class="form-control" style="margin-bottom: 10px;">
  <label>내용:</label>
  <input type="text" id="scheduleContent" class="form-control" placeholder="예: 회의, 점검 등" style="margin-bottom: 15px;">
